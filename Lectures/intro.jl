...
using Colors, WGLMakie

# ╔═╡ b8eb2d42-a432-46e3-8700-1c0b7e2ad134
using Plots, PlutoUI, PlutoUI.ExperimentalLayout, HypertextLiteral, PlutoTeachingTools, ShortCodes
...
begin
	s = WGLMakie.surface(0:20, 0:20, grade)
	WGLMakie.surface!(0:20, 0:20, (x, y) -> 10, color = :grey)
	s
end
...
manifest_format = "2.0"
project_hash = "376020e505ff6781d808c644a72b91955b5eff05"
